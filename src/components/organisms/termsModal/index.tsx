...
const TermsModal = () => {
  ...
  useEffect(() => {
    if (localStorage.getItem("terms-conditions") === "disabled") {
      setShow(false);
    } else {
      setShow(true);
    }
  ...
  const handleClose = () => {
    localStorage.setItem("terms-conditions", "disabled");
    setShow(false);
  };
  ...
  return (
    ...
    >
      <div
        className="content max-h-[400px] overflow-auto px-4"
      ...
      >
        <p className={"mb-2"}>
          ...
          between you and the Company (as defined below) that govern your access
          and/or use of: (a) the website located at{" "}
          <a
          ...
          and (the “Website”); (b) the pSTAKE Protocols (as defined below); and
          (c) the Persistence Chain (as defined below) and other chains on which
          the pSTAKE Protocols (as defined below) are deployed (collectively,
          the “<b>pSTAKE Deployed Chains</b>”) in respect of pSTAKE, including
          related trademarks, and other intellectual property, whether such
          access and/or use is via (i) the Website (“<b>Website Access</b>”) or
          (ii) command line, locally installed programs, Software Development
          Kits (“SDK”), software code and blockchain and smart contract
          explorers (collectively “<b>Direct Access</b>”). These Terms are to be
          read together with the provisions set forth in our privacy policy
          found at{" "}
          <a
        ...
        <p className={"mb-2"}>
          ...
          pSTAKE Deployed Chains (to the extent pSTAKE is deployed or integrated
          to such pSTAKE Deployed Chains) shall be collectively referred to as “
          <b>pSTAKE</b>”. By accessing and/or using pSTAKE, you (“<b>you</b>” or
          the “<b>User</b>”) agree to these Terms on behalf of yourself and any
          entity you represent, and you represent and warrant that you have the
          right and authority to do so.
        </p>
        <p className="text-light-emphasis m-2">
          ...
          in, or accessing or using the Website from, an Excluded Jurisdiction.
        ...
        <p className={"mb-2"}>
          You acknowledge that you shall be deemed to have accepted these Terms
          by accessing and/or using pSTAKE–whether by Website Access or Direct
          Access.
        </p>
        <p className={"mb-2"}>
          Company reserves the right to change these Terms in its sole
          discretion from time to time. The “<b>Date Last Revised</b>” specified
          ...
          shall indicate your acknowledgement of, and agreement to be bound by,
          such updated Terms.
        </p>
        <p className={"mb-2"}>
          By accessing the Website, you acknowledge and agree that you are
          dealing solely with the Company as counterparty in respect of your use
          of pSTAKE, which shall supersede and replace all prior agreements and
        ...
        <div>
          ...
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
              ...
              Supported Tokens”) towards staking on the relevant pSTAKE Deployed
              Chain (including IBC-enabled blockchains, and other supported
              blockchains which are Ethereum Virtual Machine-compatible) on a
              non-custodial basis whilst retaining control of liquidity of the
              underlying staked digital token; and
            </li>
            <li className={"mb-2"}>
          ...
          <p className={"mb-2"}>
            1.2 pSTAKE enables Users to undertake pSTAKE Activities through the
            use computer code written based on various blockchain standard and
            programming languages (collectively, “<b>pSTAKE Protocols</b>”) as
            developed and published by Company or its Affiliate(s) at pSTAKE’s
            official Github page (“<b>Github Page</b>”).
          </p>

          <p className={"mb-2"}>1.3 For purposes of these Terms:</p>
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
            ...
            <li className={"mb-2"}>
              “<b>pSTAKE Group</b>” refers to the Company and its Affiliates and
          ...
          <p className={"mb-2"}>a reference to:</p>
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
            ...
            <li className={"mb-2"}>
              an agreement or other document is a reference to that agreement or
              document as from time to time supplemented or amended;
            </li>
            <li className={"mb-2"}>
              the masculine gender includes the feminine and neuter genders and
              vice versa;
            </li>
            <li className={"mb-2"}>
            ...
            <li className={"mb-2"}>
              any law or regulation is a reference to that law or regulation as
              amended from time to time and, where the same has been repealed,
              to any re-enactment or replacement of the same.
            </li>
          </ul>
          <p className={"mb-2"}>1.4 Website Access</p>
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
              The Website is a user interface designed by Company to facilitate
              use of the pSTAKE Protocols by providing a user-friendly interface
              to access and/or use the pSTAKE Protocols, although the pSTAKE
              Protocols are also accessible / can be used via Direct Access.
              Company may modify or discontinue support for the Website at any
          ...
          <p className={"mb-2"}>1.5 Direct Access</p>
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
              With the necessary technical expertise, it is possible for a User
              to generate transaction messages to interact with the pSTAKE
              Protocols via Direct Access directly without use of the Website.
          ...
          <p className={"mb-2"}>1.6 pSTAKE Protocols.</p>
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
              Apart from Website Access and Direct Access, the pSTAKE Protocols
              may also be accessible now or in the future through other
              applications built on the pSTAKE Deployed Chains.
            </li>
            <li className={"mb-2"}>
              ...
              provided herein, you shall not acquire and/or own any legal right,
              title and/or interest in the pSTAKE Protocols or any intellectual
              property rights associated thereto, which shall be wholly owned by
              the Company (and/or its Affiliates).
            </li>
          </ul>
          <p className={"mb-2"}>1.7 Transaction Fees.</p>
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
              ...
              Protocols, or otherwise. Please refer to the Website or the pSTAKE
              Documentation for the relevant fees which may change from time to
              time.
            </li>
            <li className={"mb-2"}>
              User hereby consents to such fees (if applicable) being debited
              from such User’s pSTAKE Deployed Chain-compatible wallet that such
              User connects to the pSTAKE Protocols for purposes of effecting a
              pSTAKE Transaction, at the time such pSTAKE Transaction is
              processed. Similar transaction fees may also be levied on Users
              accessing and using the pSTAKE Protocols via Direct Access.
            </li>
            <li className={"mb-2"}>
              Such Transaction Fees are subject to variation through
              decentralised on-chain governance with such variation implemented
              by Company via variations to the pSTAKE Protocols.
            </li>
          </ul>
        </div>
        <p className={"text-light-emphasis mb-2"}>
        ...
        <div>
          <p className={"mb-2"}>2.1 Liquid Staking</p>
          <ul>
            <li className={"mb-2"}>
              Liquid staking may be effected via the “Stake” feature accessible
              through the Website or Direct Access, subject to the unbonding
              parameters of the relevant pSTAKE Deployed Chain which the liquid
            ...
            <li className={"mb-2"}>
              ...
              staked token is native and the pSTAKE Protocols’ parameters;
              <br />
              for purposes of these Terms, “<b>Liquid Staking</b>” shall broadly
              refer to the activities described in Sections 2.1(a) and 2.1(b)
              and all other activities ancillary in respect thereof through the
              use of the pSTAKE Protocols;
            </li>
            <li className={"mb-2"}>
              ...
              <ul className={"list-decimal pl-5"}>
                ...
                <li className={"mb-2"}>
                  ...
                  subject of potential hacks, exploits and compromise (including
                  risks associated with third-party integrations available for
                  use in association with pSTAKE e.g. Metamask, Keplr, etc.).
                </li>
              </ul>
              <b>
                {" "}
        ...
        <div>
          ...
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
              ...
              right, power and authority to access and/or use pSTAKE (including
              the tools made available via pSTAKE), and to enter into and comply
              with these Terms;
            </li>
            <li className={"mb-2"}>
              ...
              pSTAKE, and/or from using the Supported Wallet in connection with
              User’s use of pSTAKE;
            </li>
            <li className={"mb-2"}>
              User is compliant with all laws of any jurisdiction applicable to
              User in relation to User’s access and/or use of pSTAKE and
              acknowledges and agrees that the pSTAKE Group is not liable for
              User’s compliance or non-compliance with any such laws;
            </li>
            <li className={"mb-2"}>
              User’s access and/or use of pSTAKE does not require the Company or
              any other entity associated with pSTAKE to be registered, licensed
              or granted approval in order for User to use or continue using
              pSTAKE;
            </li>
            <li className={"mb-2"}>
              User is not an Excluded Person (as defined below), and User is not
              accessing and/or using pSTAKE from an Excluded Jurisdiction (as
              defined below);
            </li>
            <li className={"mb-2"}>
            ...
            <li className={"mb-2"}>
              User is the legal and beneficial owner of, or is authorized by the
              owner of the Supported Wallet to hold and/or deploy, the pSTAKE
              Supported Token; and
            </li>
            <li className={"mb-2"}>
              ...
              warranty, express or implied, made by or on behalf of pSTAKE Group
              with respect to pSTAKE whether as regards the suitability,
          ...
          <p className={"mb-2"}>
            ...
            true, complete, accurate and not misleading from the time of User’s
            acceptance of these Terms and are deemed repeated each time User
            uses pSTAKE.
          </p>
          <p className={"mb-2"}>
            3.2{" "}
          ...
          <p className={"mb-2"}>
            ...
            necessary to use and/or access pSTAKE, and for acquiring compatible
            hardware or device necessary to access and use pSTAKE and any
            updates thereto.{" "}
          </p>
          <p className={"mb-2"}>
            3.5 Use of pSTAKE may be disrupted as a result of malfunction and/or
            delays which are inherent to the use of the internet and electronic
            communications, and User agrees that the pSTAKE Group shall not be
            responsible for any such disruption, malfunction and/or delay, and
            any loss which may arise therefrom.{" "}
          </p>
          <p className={"mb-2"}>
          ...
          <p className={"mb-2"}>
            3.7 User shall not modify, adapt or hack the Website and/or pSTAKE,
            or modify any other website and/or protocol so as to falsely imply
            that such other website and/or protocol is associated with the
            Website and/or pSTAKE and/or its Affiliates (as defined below) in
            any way. User shall not crawl, scrape, cache or otherwise access any
            content from the Website via automated means, and User shall not use
            automated data collection, data mining, robots or any other data
            gathering methods of any kind on the Website and/or pSTAKE.{" "}
          </p>
          <p className={"mb-2"}>
            ...
            hyperlinks are displayed only for User’s convenience, and we assume
            no responsibility for the use of any third-party software or other
        ...
        <div>
          ...
          <ul className={"list-disc pl-5"}>
            ...
            <li className={"mb-2"}>the People’s Republic of China;</li>
            <li className={"mb-2"}>
            ...
            <li className={"mb-2"}>
              a jurisdiction in which pSTAKE and the use of which are prohibited
              or would be subject of licensing, permissions or approvals.
            </li>
          </ul>
          <p className={"mb-2"}>
          ...
          <ul className="list-disc pl-5">
            ...
            <li className={"mb-2"}>
              an individual or body corporate accessing and/or using pSTAKE from
              within an Excluded Jurisdiction;
            </li>
            <li className={"mb-2"}>
            ...
            <li className={"mb-2"}>
              ...
              applicable to such individual or body corporate from accessing
              and/or using pSTAKE; and/or
            </li>
            <li className={"mb-2"}>a U.S. person.</li>
          </ul>
          <p className={"mb-2"}>4.3 “U.S. person” means:</p>
          <ul className="list-disc pl-5">
            <li className={"mb-2"}>
            ...
            <li className={"mb-2"}>
              any citizen of United States who is a military personnel of United
              States who is not resident in or outside of the United States,
            </li>
            <p className={"mb-2"}>but does not include :</p>
            <li className={"mb-2"}>
              any discretionary account or similar account (other than an estate
        ...
        <div>
          ...
          <p className={"mb-2"}>5.1 access and/or use pSTAKE:</p>
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
          ...
          <p className={"mb-2"}>
            ...
            blockchain address User controls or otherwise engage in transactions
            using pSTAKE for any person other than the wallet owner;
          </p>
          <p className={"mb-2"}>
            5.3 disrupt, interfere with, or otherwise adversely affect the
            normal flow or function of pSTAKE or otherwise act in a manner that
            may negatively affect other users’ experience when using pSTAKE, and
            User shall not take advantage of software vulnerabilities and any
            other act that intentionally abuses or exploits the design and
            functions of pSTAKE;
          </p>
          <p className={"mb-2"}>
          ...
          <p className={"mb-2"}>
            5.8 reverse engineer or attempt to reverse engineer pSTAKE except as
            expressly permitted by applicable law, (collectively, “Prohibited
            Uses”)
          </p>
        </div>
        <p className={"text-light-emphasis mb-2"}>
        ...
        <div>
          <p className={"mb-2"}>
            6.1 User agrees and acknowledges that neither pSTAKE nor any of our
            Affiliates (as defined below) shall be liable to User for any
            direct, indirect, special, incidental, consequential or other losses
            of any kind, in tort, contract or otherwise (including but not
            limited to loss of revenue, income or profits, and loss of use or
            data), arising out of or in connection with User’s access and/or use
            of pSTAKE.
          </p>
          <p className={"mb-2"}>
          ...
          <p className={"mb-2"}>
            ...
            tortious claims) or contract against the pSTAKE Group and its
            Affiliates in connection with User’s access and/or use of pSTAKE.
          </p>
        </div>
        <p className={"text-light-emphasis mb-2"}>7. Termination</p>
        <div>
          <p className={"mb-2"}>
            7.1 These Terms shall remain in full force and effect and be legally
            binding on User for so long as User accesses and/or uses pSTAKE.
          </p>
          <p className={"mb-2"}>
          ...
          <p className={"mb-2"}>
            ...
            which User uses to access and/or use pSTAKE.
          </p>
          <p className={"mb-2"}>
        ...
        <p className={"text-light-emphasis mb-2"}>8. Disclaimer</p>
        <div>
          <p className={"mb-2"}>
          ...
          <ul className={"list-disc pl-5"}>
            ...
            <li className={"mb-2"}>
              ...
              WARRANTY AND/OR CONDITION OF ANY KIND THAT PSTAKE WILL MEET USER’S
            ...
            <li className={"mb-2"}>
              NEITHER PSTAKE NOR ANY OF ITS AFFILIATES IS USER’S BROKER, AGENT,
              TAX OR LEGAL ADVISOR, AND HAS NO FIDUCIARY RELATIONSHIP WITH OR
              OBLIGATION TO USER. NO COMMUNICATION OR INFORMATION PROVIDED BY
              PSTAKE OR ANY OF ITS AFFILIATES IS INTENDED AS OR SHALL BE
              CONSTRUED AS INVESTMENT, FINANCIAL, TAX, LEGAL OR ANY OTHER KIND
              OF ADVICE. THE pSTAKE GROUP SHALL NOT BE LIABLE FOR ANY DECISIONS
              USER MAKES TO ACCESS AND/OR USE PSTAKE.
            </li>
            <li className={"mb-2"}>
              ...
              THE DATE OF FIRST ACCESS AND/USE BY USER OF PSTAKE.
            </li>
          </ul>
          <p className={"mb-2"}>
            8.2 THE PSTAKE GROUP DOES NOT ENDORSE ANY THIRD PARTY AND SHALL NOT
        ...
        <p className={"text-light-emphasis mb-2"}>9. Limitation of Liability</p>
        <div>
          <p className={"mb-2"}>
            9.1 TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL PSTAKE
            ...
            USER’S ACCESS AND/OR USE OF PSTAKE, EVEN IF THE COMPANY AND/OR ANY
          ...
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>WHETHER PURSUANT TO THESE TERMS; AND/OR</li>
            <li className={"mb-2"}>
              WHETHER FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE
              ACTION,
            </li>
          </ul>
          <p className={"mb-2"}>
        ...
        <p className={"text-light-emphasis mb-2"}>10. Indemnification</p>
        <div>
          <p className={"mb-2"}>
            ...
            and representatives (collectively, “<b>Indemnified Party</b>”),
            harmless, including costs and attorneys’ fees, from any loss, claim
            or demand made due to or arising out of:
          </p>
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>User’s access and/or use of pSTAKE;</li>
            <li className={"mb-2"}>User’s violation of these Terms; </li>
            <li className={"mb-2"}>
        ...
        <p className={"text-light-emphasis mb-2"}>11. Tax Implications</p>
        <div>
          <p className={"mb-2"}>
            User is solely responsible for determining the tax implications and
            tax reporting requirements associated with transactions User engages
            in using pSTAKE, and for paying any applicable taxes in each
            applicable jurisdiction. Neither pSTAKE nor any of our Affiliates
            shall be responsible for determining whether there are tax
            implications in connection with transactions involving User’s use of
            pSTAKE, for reporting any such transactions, or for paying any
            applicable taxes.
          </p>
        </div>
        <p className={"text-light-emphasis mb-2"}>
        ...
        <div>
          ...
          <p className={"mb-2"}>
            12.2 Using digital assets, staking, providing liquidity and/or other
            forms of interfacing with digital assets entails a high financial
            risk. User has necessary experience and knowledge to understand the
            risks involved. User should carefully assess User’s financial
            circumstances and risk tolerance and where appropriate, seek third
            party financial advice before engaging in the aforementioned
            activities.
          </p>
          <p className={"mb-2"}>
          ...
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
              ...
              for educational purposes and to keep investors informed of prices,
              ranges, and volatility of digital assets and derivatives thereof.
              No person in the pSTAKE Group acts as your broker, intermediary,
              agent or advisor in any capacity; and{" "}
            </li>
            <li className={"mb-2"}>
              any marketing, promotion or offer for any product or investment to
              User or any third party. User shall be solely responsible for any
              losses, damages or costs resulting from User’s reliance on any
              data or information on the Website or otherwise. User shall be
              responsible for User’s decisions relating to pSTAKE which are
              User’s own.
            </li>
          </ul>
          <p className={"mb-2"}>
          ...
          <p className={"mb-2"}>
            ...
            is relatively new and it is not possible to guarantee that the code
            is completely free from bugs or errors.
          </p>
          <p className={"mb-2"}>
            12.6 User accepts all risks that arise from User’s access and/or use
            of pSTAKE, including and not limited to, the risk of any of pSTAKE
            Supported Tokens being lost due to a failure or exploit of pSTAKE.
          </p>
          <p className={"mb-2"}>
          ...
          <p className={"mb-2"}>
            ...
            transfer any pSTAKE Supported Tokens accessible through User’s
            Supported Wallet.
          </p>
          <p className={"mb-2"}>
            12.9 In choosing to access and/or use pSTAKE, User does so on User’s
            own initiative and at User’s own risk, and User is responsible for
            complying with all applicable local laws, rules and regulations
            relating to User’s access and/or use of pSTAKE.
          </p>
          <p className={"mb-2"}>
            12.10 Support for the pSTAKE may be modified or discontinued at any
            time in pSTAKE Group’s sole discretion.
          </p>
          <p className={"mb-2"}>
            ...
            version of a digital asset (“Forked Asset”), pSTAKE may not support
            activity related to any Forked Assets. Forked Networks and the
            available supply of any Forked Assets are wholly outside pSTAKE
            Group’s control. In the event of a Fork, pSTAKE Group may
            temporarily suspend certain services on the Website (with or without
            advance notice to User) while it is determined which Forked
            Network(s) to support. pSTAKE Group shall not be responsible for a
            lack of support for any Forked Asset.
          </p>
          <p className={"mb-2"}>
            12.12 By using pSTAKE, User is using pSTAKE “as is” and “as
            available” with no representations or warranties whatsoever. To the
            maximum extent permitted by law, neither the Company nor any of its
            Affiliates makes any express or implied representations and
            ...
            non-infringement in relation to pSTAKE. Neither the Company nor any
            of its Affiliates is responsible or liable for any error, delay or
            interruption in or lack of access to pSTAKE or for any loss of
            digital assets (including but not limited to pSTAKE Supported
            Tokens) occasioned by or attributable to the pSTAKE.
          </p>
          <p className={"mb-2"}>
            12.13 Any acquisition, holding or disposal by you of PSTAKE Tokens
            is solely in relation to your participation in governance of pSTAKE
            and not for any other purpose, including investments. You further
            acknowledge and agree not to acquire, hold, and/or dispose PSTAKE
            Tokens if doing so is prohibited or subject of compliance in the
            relevant jurisdiction applicable including circumstances where your
            interaction in PSTAKE Tokens results in PSTAKE Tokens and/or your
            activities associated with PSTAKE Tokens be construed by applicable
            laws and regulations (including but not limited to securities laws)
            as a regulated activity, whether or not such regulations require the
            Company and/or its Affiliates be registered, licensed or approved in
            connection with the activities described in the foregoing of this
            Section 12.13 or the pSTAKE Activities.{" "}
          </p>
        </div>
        <p className={"text-light-emphasis mb-2"}>
        ...
        <div>
          ...
          <p className={"mb-2"}>13.2 For contractual purposes, User:</p>
          <ul className={"list-disc pl-5"}>
            <li className={"mb-2"}>
            ...
            <li className={"mb-2"}>
              acknowledges and agrees that all terms and conditions, agreements,
              notices, disclosures, and other communications that the Company
              provides to User electronically satisfy any legal requirement that
              would also be satisfied if such communications were to be in a
              hardcopy writing.
            </li>
          </ul>
        </div>
        <p className={"text-light-emphasis mb-2"}>14. General</p>
        <div>
          <p className={"mb-2"}>
            14.1 <b>Entire Terms</b> - These Terms (read together with our
            Privacy Policy) constitute the entire agreement between User and the
            Company regarding User’s access and/use of pSTAKE.
          </p>
          <p className={"mb-2"}>
          ...
          <p className={"mb-2"}>
            ...
            Terms will be deemed to be construed as creating a partnership or an
            agency relationship or joint venture between User, the Company
          ...
          <p className={"mb-2"}>
            ...
            in violation of the foregoing will be null and void. The Company may
            freely assign these Terms and our respective rights thereunder.
          </p>
          <p className={"mb-2"}>
            ...
            shall apply only to the circumstances for which it is given. Failure
            of the Company to exercise or enforce any right or remedy under
            these Terms shall not operate as a waiver of such right or remedy,
            nor shall it prevent any future exercise or enforcement of such
            right or remedy, and no single or partial exercise of any right or
            remedy shall preclude or restrict the further exercise of any such
          ...
          <p className={"mb-2"}>
            ...
            be constituted by User’s acceptance of these Terms, and any dispute
            or claim arising out of or in connection with the subject matter or
            formation (including non-contractual disputes or claims) of such
            agreement, shall be governed by and construed in accordance with the
            law of Singapore. The Parties agree that any dispute or claim
            arising out of or in connection with the subject matter or formation
            (including non-contractual disputes or claims) of these Terms shall
            be by arbitration, and judgment upon the award may be entered by any
