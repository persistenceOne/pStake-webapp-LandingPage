...
export const CHAIN = {
  Testnet: {
    ...
    atomURL: "https://testnet-atom.app.pstake.finance/",
    xprtURL: "https://testnet-xprt.app.pstake.finance/",
  ...
  Staging: {
    ...
    atomURL: "https://staging-atom.app.pstake.finance/",
    xprtURL: "https://staging-xprt.app.pstake.finance/",
    DEFILAMA_API: "https://api.llama.fi/protocol/pstake",
    ethplorerAPI: "https://api.ethplorer.io/getTokenInfo/",
    getETHPrice:
  ...
  Mainnet: {
    ...
    atomURL: "https://atom.app.pstake.finance/",
    xprtURL: "https://xprt.app.pstake.finance/",
    DEFILAMA_API: "https://api.llama.fi/protocol/pstake",
    ethplorerAPI: "https://api.ethplorer.io/getTokenInfo/",
    getETHPrice:
      "https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=USD",
