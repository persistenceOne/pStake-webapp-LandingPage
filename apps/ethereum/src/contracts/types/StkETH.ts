...
export interface StkETHInterface extends utils.Interface {
  functions: {
    ...
    "burn(address,uint256,bytes,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "burn(address,uint256,bytes,bytes)",
    values: [
...
export interface StkETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StkETHInterface;
